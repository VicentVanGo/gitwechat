...
Page({
  ...
  onLoad: function (option) {
    ...
    var skey = option['searchType'];
    var that = this
    wx.request({
      url: 'https://znbook.cn/driversr',//换成实际接口地址
      data: { 'keyname': skey },
      success: function (res) {
        ...
        for (var d = 0; d < res['data']['num']; d++) {
          ...
          console.log("111");
          LIST[d] = { "bugid": res['data']['my'][d][0], "summary": res['data']['my'][d][1], "driver": res['data']['my'][d][3], "color": res['data']['my'][d][2]};
        }
        console.log(LIST);
        that.setData({
          listData: LIST
