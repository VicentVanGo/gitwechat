...
Page({
  data: {
    ...
    selectData: ['67u1cycle2','67u1cycle1'],//下拉列表的数据
    index: 0, //选择的下拉列表下标
  ...
  onReady: function (e) {
    ...
    wx.request({
      url: 'https://znbook.cn/hpqc/upreg',//换成实际接口地址
  ...
  updateData: function () {
    ...
    //let CIndex = this.optionTap.Index;
    wx.request({
      url: 'http://123.206.68.186:443/hpqc/upreg',//换成实际接口地址
      data: { 'cycle': this.data.selectData[this.data.index]},
      success: function (res) {
        console.log('3333333333333333');
        console.log('id from server is: ' + res['data']['date']);// 控制台显示 1
  ...
  onReady: function (e) {
    ...
    //let CIndex = this.optionTap.Index;
    wx.request({
      url: 'http://123.206.68.186:443/hpqc/fetchup',//换成实际接口地址
      //data: { 'cycle': this.data.selectData[this.data.index] },
      success: function (res) {
        console.log('3333333333333333');
